...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20230806074945_efcoreDiscount")]
    partial class efcoreDiscount
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.Base.Banner", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("BannerOneLeftId")
                        .HasColumnType("int");

                    b.Property<string>("BannerOneLeftUrl")
                        .HasMaxLength(2000)
                        .HasColumnType("nvarchar(2000)");

                    b.Property<int?>("BannerOneRightId")
                        .HasColumnType("int");

                    b.Property<string>("BannerOneRightUrl")
                        .HasMaxLength(2000)
                        .HasColumnType("nvarchar(2000)");
                    ...
                    b.Property<string>("BannerThreeUrl")
                        .HasMaxLength(2000)
                        .HasColumnType("nvarchar(2000)");

                    b.Property<int?>("BannerTwoId")
                        .HasColumnType("int");

                    b.Property<string>("BannerTwoUrl")
                        .HasMaxLength(2000)
                        .HasColumnType("nvarchar(2000)");
                    ...
                    b.HasIndex("BannerOneLeftId");

                    b.HasIndex("BannerOneRightId");

                    b.HasIndex("BannerThreeId");

                    b.HasIndex("BannerTwoId");
            ...
            modelBuilder.Entity("Core.Entities.Base.ContactUSList", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Entities.Base.Setting", b =>
                {
                    ...
                    b.Property<bool>("IsFreeSender")
                        .HasColumnType("bit");

                    b.Property<bool>("IsPayInLocation")
                        .HasColumnType("bit");

                    b.Property<bool>("IsPaybyUser")
                        .HasColumnType("bit");
                    ...
                    b.Property<long>("PriceAsStore")
                        .HasColumnType("bigint");

                    b.Property<long>("PriceFree")
                        .HasColumnType("bigint");

                    b.Property<long>("PriceOtherProvince")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Core.Entities.Base.Sider", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Entities.Prodcutes.Color", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Entities.Prodcutes.ProductPrice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Entities.Base.Banner", b =>
                {
                    b.HasOne("Core.Entities.Base.File", "BannerLeftOne")
                        .WithMany()
                        .HasForeignKey("BannerOneLeftId");

                    b.HasOne("Core.Entities.Base.File", "BannerOneRight")
                        .WithMany()
                        .HasForeignKey("BannerOneRightId");

                    b.HasOne("Core.Entities.Base.File", "BannerThree")
                        .WithMany()
                        .HasForeignKey("BannerThreeId");

                    b.HasOne("Core.Entities.Base.File", "BannerTwo")
                        .WithMany()
                        .HasForeignKey("BannerTwoId");

                    b.Navigation("BannerLeftOne");

                    b.Navigation("BannerOneRight");

                    b.Navigation("BannerThree");

                    b.Navigation("BannerTwo");
                });
            ...
            modelBuilder.Entity("Core.Entities.Prodcutes.ProductPrice", b =>
                {
                    b.HasOne("Core.Entities.Prodcutes.Color", "Color")
                        .WithMany()
