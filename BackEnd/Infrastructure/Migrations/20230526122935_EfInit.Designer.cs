...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20230526122935_EfInit")]
            ...
            modelBuilder.Entity("Core.Entities.Prodcutes.ProductPropertyValue", b =>
                {
                    ...
                    b.Property<int>("ProductsFilterId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Entities.Prodcutes.ProductPropertyValue", b =>
                {
                    ...
                    b.HasOne("Core.Entities.Prodcutes.ProductsFilter", "ProductsFilter")
                        .WithMany()
                        .HasForeignKey("ProductsFilterId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("DefinedProduct");

                    b.Navigation("ProductsFilter");
                });
